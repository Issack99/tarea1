#Baja el archivo grades.json y en la terminal ejecuta el siguiente comando:
mongoimport -d students -c grades <'/home/issack/Descargas/grades.json'
#2018-10-16T21:57:09.186-0600	connected to: localhost
#2018-10-16T21:57:09.549-0600	imported 800 documents
...
> db.grades.count()
#¿Cuántos registros arrojo el comando count? 800
...
> db.grades.deleteMany({student_id:3},{$set:{score:0}});
